...
The project helps the user to identify the future chances whether someone is would be suffering from diabetes by simply inputting certain values like BMI, Glucose level, Blood pressure etc. with the help of a Kaggle database.
